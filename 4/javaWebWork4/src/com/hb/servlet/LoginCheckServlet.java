	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{	
			...
			if(userC!=null)
			{
				...
				request.getSession(true).setAttribute("haveLogin", "yes");
				request.getSession(true).setAttribute("user", user);//用户信息存入session
			...
			{
				request.setAttribute("message", "账号不存在或密码错误");
